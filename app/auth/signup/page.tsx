  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-60 right-60 text-gray-400 animate-float text-sm" style={{animationDelay: '5s'}}>🌟</div>
      </div>
      ...
      <Card className="w-full max-w-md relative z-10 bg-gradient-to-br from-white/95 via-gray-50/90 to-white/95 backdrop-blur-xl border border-gray-200 hover:border-gray-300 transition-all duration-500 hover:shadow-2xl animate-glow">
        <CardHeader className="text-center pb-6">
          ...
          <CardDescription className="text-black/80 text-lg leading-relaxed">
            Start your <span className="font-semibold text-gray-700">secure development journey</span> today
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="flex items-start space-x-3 pt-2">
              ...
              />
              <Label htmlFor="terms" className="text-sm text-black/80 leading-relaxed">
                I agree to the{" "}
                <Link href="/terms" className="text-gray-700 hover:text-black underline font-semibold">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-gray-700 hover:text-black underline font-semibold">
                  Privacy Policy
                </Link>
              </Label>
            </div>
            ...
            <Button 
              ...
              disabled={loading}
            >
              {loading ? "Creating your account..." : "🎯 Create DevHub Account"}
            </Button>
          </form>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-black/70">
              Already part of DevHub?{" "}
              <Link href="/auth/login" className="text-gray-700 hover:text-black underline font-semibold">
                Sign in here
              </Link>
            </p>
          </div>
